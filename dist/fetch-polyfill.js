...
var require_undici = __commonJS({
  "../deps/undici/undici.js"(exports, module) {
    "use strict";
    ...
    var require_wrap_handler = __commonJS2({
    ...
    var require_timers = __commonJS2({
    ...
    var require_util2 = __commonJS2({
      "lib/core/util.js"(exports2, module2) {
        ...
        var [nodeMajor, nodeMinor] = globalThis.process.versions.node.split(".", 2).map((v) => Number(v));
        ...
        var setupConnectTimeout = globalThis.process.platform === "win32" ? (socketWeakRef, opts) => {
          if (!opts.timeout) {
            return noop;
          }
          let s1 = null;
    ...
    var require_unwrap_handler = __commonJS2({
    ...
    var require_data_url = __commonJS2({
    ...
    var require_webidl = __commonJS2({
      "lib/web/webidl/index.js"(exports2, module2) {
        "use strict";
        var { types, inspect } = require_util();
        var { markAsUncloneable } = require_worker_threads();
        var UNDEFINED = 1;
        var BOOLEAN = 2;
        var STRING = 3;
        var SYMBOL = 4;
    ...
    var require_util22 = __commonJS2({
      "lib/web/fetch/util.js"(exports2, module2) {
        ...
        var { ReadableStreamFrom, isValidHTTPToken, normalizedMethodRecordsBase } = require_util2();
        var assert = require_assert();
    ...
    var require_formdata = __commonJS2({
      "lib/web/fetch/formdata.js"(exports2, module2) {
        "use strict";
        var { iteratorMixin } = require_util22();
    ...
    var require_body = __commonJS2({
      "lib/web/fetch/body.js"(exports2, module2) {
        ...
        var { webidl } = require_webidl();
        var assert = require_assert();
        var { isErrored, isDisturbed } = require_stream();
...
`);
    ...
    var require_client_h1 = __commonJS2({
      "lib/dispatcher/client-h1.js"(exports2, module2) {
        ...
        var extractBody;
        function lazyllhttp() {
          const llhttpWasmData = globalThis.process.env.JEST_WORKER_ID ? require_llhttp_wasm() : void 0;
          let mod;
          let useWasmSIMD = globalThis.process.arch !== "ppc64";
          if (globalThis.process.env.UNDICI_NO_WASM_SIMD === "1") {
            useWasmSIMD = true;
          } else if (globalThis.process.env.UNDICI_NO_WASM_SIMD === "0") {
            useWasmSIMD = false;
          }
          if (useWasmSIMD) {
            try {
        ...
        function writeH1(client, request) {
          ...
          if (shouldSendContentLength(method) && contentLength > 0 && request.contentLength !== null && request.contentLength !== contentLength) {
            ...
            globalThis.process.emitWarning(new RequestContentLengthMismatchError());
          }
          const socket = client[kSocket];
...
`, "latin1");
    ...
    var require_client_h2 = __commonJS2({
...
`;
    ...
    var require_global2 = __commonJS2({
    ...
    var require_env_http_proxy_agent = __commonJS2({
      "lib/dispatcher/env-http-proxy-agent.js"(exports2, module2) {
        ...
        var EnvHttpProxyAgent2 = class extends DispatcherBase {
          ...
          constructor(opts = {}) {
            ...
            const HTTP_PROXY = httpProxy ?? globalThis.process.env.http_proxy ?? globalThis.process.env.HTTP_PROXY;
            if (HTTP_PROXY) {
              this[kHttpProxyAgent] = new ProxyAgent({ ...agentOpts, uri: HTTP_PROXY });
            } else {
              this[kHttpProxyAgent] = this[kNoProxyAgent];
            }
            const HTTPS_PROXY = httpsProxy ?? globalThis.process.env.https_proxy ?? globalThis.process.env.HTTPS_PROXY;
            if (HTTPS_PROXY) {
          ...
          get #noProxyEnv() {
            return globalThis.process.env.no_proxy ?? globalThis.process.env.NO_PROXY ?? "";
          }
        };
    ...
    var require_request2 = __commonJS2({
      "lib/web/fetch/request.js"(exports2, module2) {
        ...
        var { kConstruct } = require_symbols();
        var assert = require_assert();
        var { getMaxListeners, setMaxListeners, defaultMaxListeners } = require_events();
          ...
          constructor(input, init = void 0) {
            ...
            if (init.method !== void 0) {
              ...
              if (!patchMethodWarning && request.method === "patch") {
                globalThis.process.emitWarning("Using `patch` is highly likely to result in a `405 Method Not Allowed`. `PATCH` is much more likely to succeed.", {
    ...
    var require_subresource_integrity = __commonJS2({
    ...
    var require_fetch = __commonJS2({
      "lib/web/fetch/index.js"(exports2, module2) {
        ...
        var { Readable, pipeline, finished, isErrored, isReadable } = require_stream();
        var { addAbortListener, bufferToLowerCasedHeaderName } = require_util2();
        ...
        function schemeFetch(fetchParams) {
          ...
          switch (scheme) {
            ...
            case "blob:": {
              if (!resolveObjectURL) {
                resolveObjectURL = (init_buffer_polyfill(), __toCommonJS(buffer_polyfill_exports)).resolveObjectURL;
              }
    ...
    var require_events2 = __commonJS2({
    ...
    var require_util3 = __commonJS2({
      "lib/web/websocket/util.js"(exports2, module2) {
        ...
        var { isUtf8 } = (init_buffer_polyfill(), __toCommonJS(buffer_polyfill_exports));
        ...
        var utf8Decode = (() => {
          if (typeof globalThis.process.versions.icu === "string") {
    ...
    var require_connection = __commonJS2({
      "lib/web/websocket/connection.js"(exports2, module2) {
        ...
        var { getDecodeSplit } = require_util22();
    ...
    var require_permessage_deflate = __commonJS2({
      "lib/web/websocket/permessage-deflate.js"(exports2, module2) {
        "use strict";
        var { createInflateRaw, Z_DEFAULT_WINDOWBITS } = require_zlib();
    ...
    var require_websocket = __commonJS2({
      "lib/web/websocket/websocket.js"(exports2, module2) {
        ...
        var { webidl } = require_webidl();
        var { URLSerializer } = require_data_url();
        var { environmentSettingsObject } = require_util22();
        ...
        var { kEnumerableProperty } = require_util2();
        var { getGlobalDispatcher: getGlobalDispatcher2 } = require_global2();
        var { ErrorEvent: ErrorEvent2, CloseEvent: CloseEvent2, createFastMessageEvent: createFastMessageEvent2 } = require_events2();
    ...
    var require_eventsource_stream = __commonJS2({
...
${value}`;
    ...
    var require_eventsource = __commonJS2({
      "lib/web/eventsource/eventsource.js"(exports2, module2) {
        ...
        var { createFastMessageEvent: createFastMessageEvent2 } = require_events2();
        ...
        var EventSource = class _EventSource extends EventTarget {
          ...
          constructor(url, eventSourceInitDict = {}) {
            ...
            if (!experimentalWarned) {
              ...
              globalThis.process.emitWarning("EventSource is experimental, expect them to change at any time.", {
                code: "UNDICI-ES"
              });
            }
            url = webidl.converters.USVString(url);
    ...
    module.exports.fetch = /* @__PURE__ */ __name(function fetch2(init, options = void 0) {
    ...
    var { CloseEvent, ErrorEvent, MessageEvent, createFastMessageEvent } = require_events2();
