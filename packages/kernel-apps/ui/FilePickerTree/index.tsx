...
// CSS classes (since we're using regular CSS now, not CSS modules)
const css = {
	'file-picker-tree': 'file-picker-tree',
	'file-node-button': 'file-node-button',
	'selected': 'selected',
	'focused': 'focused',
	...
	'file-name': 'file-name',
	'path-picker-control': 'path-picker-control',
	...
	useImperativeHandle(
		...
		() => ({
			...
			createFile: async (absSelectedPath?: string) => {
				await createNode(absSelectedPath, 'file', 'untitled');
			},
