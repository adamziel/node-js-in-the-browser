import {
  require_promises
} from "./chunk-PDDEV64J.js";
import {
  require_abort_listener,
  require_callbacks,
  require_emitKeypressEvents,
  require_errors,
  require_inspect,
  require_interface,
  require_util3 as require_util,
  require_validators
} from "./chunk-JNJS524C.js";
import {
  __commonJS
...
var require_readline = __commonJS({
  "../lib/readline.js"(exports, module) {
    var {
      DateNow,
    ...
    var emitKeypressEvents = require_emitKeypressEvents();
    ...
    function Interface(input, output, completer, terminal) {
      ...
      if (globalThis.process.env.TERM === "dumb") {
